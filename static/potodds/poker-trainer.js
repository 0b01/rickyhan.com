...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof window === "undefined" && typeof process === "object" ) {
            ...
            var wasm_path = path.join( __dirname, "poker-trainer.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            return fetch( "/static/potodds/poker-trainer.wasm", {credentials: "same-origin"} )
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__extjs_50d409ed79004376c2f49da5104a192fa96ffb85": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){document.querySelector ("#txtbox"). innerHTML += ($1)+ "<br />" ;})());
            },
            "__extjs_9a19eafa6f42a14d0914fcf8a615aeb4cf994a0e": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){document.querySelector ("#txtbox"). innerHTML = "" ;})());
            },
            "__extjs_dd7c705a4c64b69ca877a5c811da75da7efee65b": function($0, $1, $2) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);Module.STDWEB_PRIVATE.from_js($0, (function(){let x = document.querySelector (($1)); while (x){x.remove (); x = document.querySelector (($2));};})());
            },
